...
<body>
 ...
 <div id="tb3" style="padding:5px;height:auto">
                         <div>
	                       ...
	                       <span class="toolbar-item dialog-tool-separator"></span>
	                       <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-tip" plain="true" title="支持多种关系型数据库、&#13;定时执行SQL命令语句.&#13;启用状态的任务将自动运行."></a>
  ...
  <div id="dlgg2" ></div> 
 <table id="dg3"></table>  
 <script type="text/javascript" src="${ctx}/static/js/taskList.js"> </script>  
</body>
</html>